...
app.layout = html.Div([
    html.Div(
        ...
        children=[
            html.H1("Dynamic Data Graph", className="ui header", style={"color": "#FFFFFF"}),
            html.P("Select columns to display on the graph.", className="ui sub header", style={"color": "#D3D3D3"}),
        ],
        style={
    ...
    html.Div(
        ...
        children=[
            dcc.Tabs(id='tabs', value='graph-tab', children=[
                dcc.Tab(label='Data Plot', value='graph-tab', className='ui blue tab', style={"borderRadius": "10px"}),
                dcc.Tab(label='News Headlines', value='news-tab', className='ui blue tab', style={"borderRadius": "10px"})
            ]),

            html.Div(id='tabs-content', className='ui padded segment', style={"borderRadius": "10px"})
        ],
...
def render_content(tab):
    if tab == 'graph-tab':
        ...
        ], className="ui raised segment", style={"borderRadius": "10px"})
    elif tab == 'news-tab':
        return html.Div([
            html.H3("Latest News Headlines", className="ui header", style={"color": "#FFFFFF"}),
            html.Ul([html.Li("News item 1", style={"color": "#D3D3D3"}), html.Li("News item 2", style={"color": "#D3D3D3"}), html.Li("News item 3", style={"color": "#D3D3D3"})], className="ui list")
        ], className="ui raised segment", style={"borderRadius": "10px"})
