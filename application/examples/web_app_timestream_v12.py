...
app.layout = html.Div([
    ...
    dcc.Tabs(id='tabs', value='graph-tab', children=[
        dcc.Tab(label='Data Plot', value='graph-tab'),
        dcc.Tab(label='News Headlines', value='news-tab')
    ]),
...
def render_content(tab):
    if tab == 'graph-tab':
        ...
        return html.Div([
            ...
            html.Ul([html.Li("News item 1"), html.Li("News item 2"), html.Li("News item 3")])
        ], style={"padding": "10px"})
