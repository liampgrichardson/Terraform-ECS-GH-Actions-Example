    ...
    html.Div(
        ...
        children=[
            dcc.Tabs(id='tabs', value='graph-tab', children=[
                dcc.Tab(label='Data Plot', value='graph-tab', style={"borderRadius": "10px", "backgroundColor": f"{custom_blue_colors[1]}10", "color": custom_blue_colors[2]}),
                dcc.Tab(label='News Headlines', value='news-tab', style={"borderRadius": "10px", "backgroundColor": f"{custom_blue_colors[1]}10", "color": custom_blue_colors[2]})
            ], style={"borderRadius": "15px", "overflow": "hidden", "backgroundColor": f"{custom_blue_colors[1]}10"}),

            html.Div(id='tabs-content', className='ui padded segment', style={"borderRadius": "15px", "backgroundColor": f"{custom_blue_colors[1]}10", "color": custom_blue_colors[2]})
        ],
...
def render_content(tab):
    if tab == 'graph-tab':
        ...
        ], className="ui raised segment", style={"borderRadius": "15px", "backgroundColor": f"{custom_blue_colors[1]}10"})
